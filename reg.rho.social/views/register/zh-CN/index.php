...
<div class="register-box">
    ...
    <div class="register-box-body">
        <p class="login-box-msg"><?= Yii::t('reg', 'Register a new membership') ?></p>
        ...
        <div class="row">
            ...
            <div class="col-xs-6">
                ...
                $form->field($model, 'gender', [
                    ...
                    'template' => "{input}\n{hint}\n{error}",
                ])->dropDownList(common\models\user\profile\Profile::$genders)
                ?>
            </div>
        </div>
        <div class="row">
        ...
        $form->field($model, 'verifyCode', [
            ...
            'captchaAction' => '/register/captcha',
        ])
        ?>
        <div class="row">
            <div class="col-xs-8">    
            ...
            <div class="col-xs-4">
                <button class="btn btn-primary btn-block btn-flat" type="submit" style="margin-top: 6px;"><?= Yii::t('reg', 'Register') ?></button>
            </div>
        </div>
        <?php ActiveForm::end() ?>
        <a class="text-center" href="<?= $ssoUrlManager->createAbsoluteUrl('sso/login'); ?>"><?= Yii::t('reg', 'I already have a membership') ?></a>
    </div>
</div>
<?php if (isset($error) && !empty($error)): ?>
    ...
    Modal::begin([
        ...
        'header' => '<h4>' . Yii::t('reg', 'Notice') . '</h4>',
        'options' => [
            'aria-hidden' => 'true',
        ]
    ]);
    ?>
    <?= YII_ENV_PROD ? Yii::t('reg', 'We are sorry to inform you that the registration process error(s) occured, we have recorded for errors and resolve as soon as possible, please understand.') : $error ?>
    <?php Modal::end(); ?>
<?php endif; ?>
