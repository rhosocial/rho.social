...
use Yii;
use common\models\api\Ratelimiter;
use Exception;
 ...
 */
class TokenRateLimiter extends Ratelimiter implements RateLimitInterface
{
    /**
    ...
    /*
      ...
      try {
      $option = Json::decode($rate_limit_option->value);
      ...
      throw new InvalidParamException('Invalid allow value.');
      }
      ...
      throw new InvalidParamException('Invalid window value.');
      }
      } catch (Exception $ex) {
      $option['allow'] = $allow;
